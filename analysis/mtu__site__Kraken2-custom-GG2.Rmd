...
author: "jamie.fitzgerald@mtu.ie"
...
> Just download the database?  - [click here](#download-greengenes2-331k-for-kraken2) / end of page
...
Please use if you think it'll be of use to you. Do keep in mind that these are currently built from the sequences __between 1.4Kbp and 1.65Kbp only__ (331K sequences, not the 23M in the full GG2 set).

###### Download GreenGenes2 331K for Kraken2

  -   `hash.k2d` - 38.4MB 
  -   `opts.k2d` - 64B 
  -   `taxo.k2d` - 1.5MB 
  
Or even so far as want to go to

  -   `full_db_tar.gz` - includes nodes and map, 2~~MB 

> see page on [Zenodo](https://zenodo.org/records/17674218?preview=1&token=eyJhbGciOiJIUzUxMiJ9.eyJpZCI6ImY2NDBmM2FlLWMxYjYtNGNmMS04NGNiLTczMjAyYmE1Y2Q4OCIsImRhdGEiOnt9LCJyYW5kb20iOiI1MjlhYWYwNjNmMTg4N2U4MTI5Zjk4Y2FhMWVjNGEwNSJ9.Ulg9pB-PM9q8WQ4ie_7I9geXDFz3qtvL2sHOZbENml00II47PrRam75JuLuFNBxEZ71N4e0BPeuDl7vNKJxePw)
...
Recording here a number of issues that needed to be taken care of _en route_ to the bottom of the page.

  -   Cake is a made up drug. We made completely fake `taxid`s, so __none of these will match NCBI__ taxonomy.
  -   as mentioned, database is built with only full length sequences (1.4 - 1.65Kbp; 331K sequences).
  ...
  -   not certain whether avoiding dustmasking for 16S is better, but there is a strong & sensible case for avoiding it.
