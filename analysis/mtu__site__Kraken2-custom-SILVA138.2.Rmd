...
Or indeed, run back and forth, forever:
  ...
  -   `full_db_tar.gz` - includes the `hash`, `opts`, & `taxo.k2d`, as well as `nodes`, `map`, & `seq.fna` files used:  ____B 

[Still processing... ~~Download here (Zenodo.org)~~](#r)
...
Honestly, I did _try_ to keep this brief, but it _is_ better now that I've removed all the haikus
